...
const textBindings = [
  ...
  ["#saveProfileButton", "saveAccount"], ["#passwordSettingsToggle span", "changePassword"],
  ["#passwordSettingsContent label:nth-of-type(1) span", "currentPassword"],
  ["#passwordSettingsContent label:nth-of-type(2) span", "newPassword"],
  ["#passwordSettingsContent label:nth-of-type(3) span", "confirmPassword"], ["#updatePasswordButton", "updatePassword"],
